...
const NoteCard = ({ note }) => {
  return (
    <Link to={`/note/${note._id}`} className="block group">
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-2 border-green-400 rounded-2xl p-6 shadow-xl hover:shadow-green-400/30 transition-all duration-300 cursor-pointer overflow-hidden">
        {/* Decorative Glow */}
        ...
        {/* Main content */}
        <div className="mb-6">
          <h3 className="text-white text-2xl font-bold mb-2 tracking-tight group-hover:text-green-400 transition-colors duration-300">
            {note.title}
          </h3>
